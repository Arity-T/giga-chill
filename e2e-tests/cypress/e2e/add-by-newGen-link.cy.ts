...
describe('Добавление участников по новой сгенерированной ссылке', () => {
    ...
    it('Добавление участника по новой сгенерированной ссылке', () => {
        ...
        // Сохраняем заново сгенерированную ссылку-приглашение в алиас inviteNewUrl
        cy.getNewInvitationLinkUI();
        ...
        cy.get<string>('@inviteNewUrl').then((inviteNewUrl) => {
            cy.visit(inviteNewUrl);
        });
