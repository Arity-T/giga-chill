...
describe('Проверка добавления участников по ссылке-приглашению', () => {
    ...
    it('Добавление участника по ссылке', function () {
    ...
    it('Добавление участника по новой сгенерированной ссылке', function () {
        // Логинимся как организатор
        cy.loginUserAPI({
            login: 'lili',
            password: '12345678'
